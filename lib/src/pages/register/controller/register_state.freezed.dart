...
mixin _$RegisterState {
  ...
  String get password => throw _privateConstructorUsedError; //contraseña
  String get Vpassword =>
      throw _privateConstructorUsedError; //confirmación de contraseña
  String get name => throw _privateConstructorUsedError;
  int get puntaje => throw _privateConstructorUsedError;
...
class _$_RegisterState implements _RegisterState {
  ...
  @JsonKey(defaultValue: '')
  @override //confirmación de contraseña
  final String name;
  ...
  @override
  String toString() {
    return 'RegisterState(email: $email, password: $password, Vpassword: $Vpassword, name: $name, puntaje: $puntaje, termsOk: $termsOk)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, email, password, Vpassword, name, puntaje, termsOk);
